...
class CabinetWebmasterModel(models.Model):
    ...
    wmr = models.CharField("wmr", max_length=100, default="")
    mobile_phone = models.CharField("mobile phone", max_length=200, default="")
    skype = models.CharField("skype", max_length=200, default="")
