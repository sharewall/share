...
def detailmain(request):
    ...
    #TODO: Bug, If not date today in db for area we have empty date, so...
    if for_1:
        areas = [areas.last(),]
    ...
    for area in areas:
        ...
        if for_1:
            area_per_day_list = AreaToday.objects.all()
        ...
        for a in area_per_day_list:
            ...
            if temp_areaPDay_date in dates:
                ...
                if temp_today_share_counter > statistic['shares']:
                    statistic['shares'] = temp_today_share_counter

                if temp_today_social_counter > statistic['socials']:
                    statistic['socials'] = temp_today_social_counter
