...
def getAdvert(request, cook):
    ...
    if wma_object:
        ...
        request_advCook = cook#request.POST.get('advCook', 'xyz123')
        ...
        }'%(request_ip, request_userAgent, wma_object.pk, request_referer, request_advCook)#.format(ip=request_ip, agent=request_userAgent)
        ...
        if area_today:
            ...
            area_today.today_money += float(advert_json_price)
            area_today.save()
